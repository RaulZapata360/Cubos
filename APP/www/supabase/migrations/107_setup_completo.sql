-- ============================================
-- SETUP COMPLETO: Usuario + Datos de Prueba
-- ============================================
-- Este script hace TODO lo necesario para que la app funcione

-- ============================================
-- PASO 1: Agregar usuario actual como jefe
-- ============================================
...
-- ============================================
-- PASO 3: Asignar contadores (usar IDs reales)
-- ============================================
...
-- ============================================
-- PASO 4: Crear materiales (8 por obra)
-- ============================================
...
-- ============================================
-- PASO 7: Crear movimientos (22 Dic solamente)
-- ============================================

-- Aeroparque (21 movimientos)
INSERT INTO movimientos (obra_id, camion_id, usuario_id, tipo, capacidad, material, ubicacion, timestamp, fecha, destino)
SELECT 
...
-- Azul (15 movimientos: 10 incoming + 5 outgoing)
INSERT INTO movimientos (obra_id, camion_id, usuario_id, tipo, capacidad, material, ubicacion, timestamp, fecha, destino)
SELECT 
...
SELECT 
  'Tu usuario' as info,
  auth.uid()::text as id,
  (SELECT rol FROM usuarios WHERE id = auth.uid()) as rol
UNION ALL
SELECT 
  'Obras creadas',
  COUNT(*)::text,
